...
public static Tokens getTokens(String text)
{
	 ...
	 */
	Pattern matchPatterns[] = {spaceMatch, quotedPattern, iteratePattern, mixedMatch, upperMatch, urlPattern, operatorPattern, calculationPattern, numberPattern,  hashPattern, decimalNumberPattern, datePattern, uuidPattern, lowerMatch};
	String tokenType[] = {"S", "Q", "I", "M", "U", "Url", "O", "C", "No", "Ha", "De", "Da", "Id", "L"};
