...
public interface RuleRepository extends JpaRepository<Rule, Long>{
	...
	@Qeury(value="SELECT R.RULE_ID, R.NAME, R.CATEGORY, F.RULE_ID, F.FILE_ID, F.CRATED_DATE, F.FILES, H.RULE_ID, H.HISTORY_ID, H.CREATED_DATE, H.HISTORY FROM RULE R, FILE F, HISTORY H, WHERE R.RULE_ID = F.RULE_ID AND R.RULE_ID = H.RULE_ID", nativeQuery = true)
